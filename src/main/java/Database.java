...
public class Database {
    ...
    void insertData(String setUsername, String setPassword){
        ...
        try (Connection connectionForDataBase = DriverManager.getConnection("jdbc:mysql://localhost:3306/HDFACustLogIn", "root", "Adiolajasho")) {
            // Create a PreparedStatement for inserting data
            String insertSQL = "INSERT INTO User_login (username, userpassword) VALUES (?, ?)";
    ...
    Boolean retrieveData(String checkUsername, String checkPassword){
        ...
        try (Connection connectionForDataBase = DriverManager.getConnection("jdbc:mysql://localhost:3306/HDFACustLogIn", "root", "Adiolajasho")) {
            ...
            String searchSQL = "SELECT username, userpassword FROM User_login WHERE username = ? AND userpassword = ?";
